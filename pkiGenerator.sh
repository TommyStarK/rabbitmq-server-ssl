...
# Generate client csr
openssl req -new -key client/rabbitmq-client-key.pem -out client/rabbitmq-client-req.pem -outform PEM -subj /CN=client/O=RandomClient/C=FR/L=Paris/ST=IdF/OU=RandomUnit/ -nodes -days 365
